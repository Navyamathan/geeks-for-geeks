<h2><a href="https://www.geeksforgeeks.org/problems/second-largest3735/1?_gl=1*r3v28m*_up*MQ..*_gs*MQ..&gclid=Cj0KCQjwxJvBBhDuARIsAGUgNfghevY5TNrFvYk_uOeo9gJKWOP8X8tDzbXNOYOES7vS_NRehG2CwuQaAvtZEALw_wcB&gbraid=0AAAAAC9yBkDjCDIwj09iFeDI4MpUKiZBB">Second Largest</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array of <strong>positive</strong> integers <strong>arr[]</strong>, return the <strong>second largest</strong> element from the array. </span><span style="font-size: 18px;">If the second largest element doesn't exist then return <strong>-1.</strong></span></p>
