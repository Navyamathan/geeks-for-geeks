<h2><a href="https://www.geeksforgeeks.org/problems/all-divisors-of-a-number/1?_gl=1*r74c04*_up*MQ..*_gs*MQ..&gclid=CjwKCAjwuIbBBhBvEiwAsNypvb5fKdog4Hyfjzk_GhfcbmH_mW1_bek-QQmL4Uo4dQCiOnIqkGprHRoC5RoQAvD_BwE&gbraid=0AAAAAC9yBkBZ7WmoeqGfHQqOI_boNP7hg">All divisors of a Number</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given&nbsp;an integer <strong>N,</strong>&nbsp;print all the divisors of N in the&nbsp;<strong>ascending </strong>order.</span><br>&nbsp;</p>
